...
**- Findings catch:**
  ...
  - a lot of "not provided" values on EDI lifestage. Since DB has not been wranggled it is hard to compare. Flagging this in case we cant to look into details
