...
message("  2. Open data-raw/qc/qc_log_errors.csv and data-raw/qc/qc_log_warnings.csv")
message("     and update 'status' and 'reviewer_notes' for each open issue")
...
message("     and record the fix_script path in the relevant qc_log_*.csv")
message("  4. Commit qc_log_errors.csv, qc_log_warnings.csv, reports/, and any fixes/ changes")
