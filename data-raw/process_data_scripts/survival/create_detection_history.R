...
detection_history_sacramento <- sacramento_detections$detections |> 
  ungroup() |> 
  arrange(fish_id) |> 
...
detection_history_feather_butte <- bind_rows(detection_history_butte,
                                             detection_history_feather) |> 
  arrange(fish_id)

usethis::use_data(detection_history_sacramento, overwrite = T)
usethis::use_data(detection_history_feather_butte, overwrite = T)
