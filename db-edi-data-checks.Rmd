...
* `r round(sum(is.na(catch_battle_db$lifestage_id))/nrow(catch_battle_db), 3)*100` % of values in the `lifestage_id` column are NA.
...
* `r round(sum(is.na(catch_battle_edi$lifestage_id))/nrow(catch_battle_edi), 3)*100` % of values in the `lifestage_id` column are NA.
