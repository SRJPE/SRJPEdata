...
* `r round(sum(is.na(release_feather_edi$nReleased))/nrow(release_feather_edi), 3)*100` % of values in the `nReleased` column in the database dataset are NA.
