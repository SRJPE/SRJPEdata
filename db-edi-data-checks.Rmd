...
#### trap
  ...
  - Findings:
    ...
    - for random test 4, there are 4 data entries on database that seem dupicate, but with different id. Is this something we should check?
