---
title: "Proposed Covariate Development for Forecast and Scenario Models"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Proposed Covariate Development for Forecast and Scenario Models}
...
This vignette focuses on developing covariates that could be used in forecast or scenario SR JPE models. We build upon prior work that identified and tested covariates using historical data, and transition to how those covariates could be adapted for use in forecast or scenario scenarios. These covariates have not been implemented and represent one proposal for forecast covariates.

## Process for developing forecast covariates

The diagram outlines the process for developing proposed covariates for forecast and scenario models. 
...
## Proposed covariates included in forecast models
...
# For Sacramento River we want separate values by site, others can be summarized by stream
