...
# SHASTA 
# TODO Query unsuccessful from website, using the USGS download data button throws an error so there may be something messed up internally 
# UPDATE WHEN RESOLVED
# siteNumber <- 11370000
# storage_code <- "00054"
# rs_shasta_monthly_raw <- dataRetrieval::readNWISdv(11370000, "00054", "1950-01-01", "2025-01-01")

rs_shasta_monthly_raw <- readxl::read_excel("data-raw/helper-tables/20250214_ShastaStorage_2013-2023.xlsx")

rs_shasta_monthly <- rs_shasta_monthly_raw |> 
  mutate(date = as.Date(Date),
         year = year(date),
         value = Storage_AcreFeet,
