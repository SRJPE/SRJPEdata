...
# saveRDS(forecast_covariates, here::here("data", "forecast_covariates.RDS")) #TODO run this once data looks good
```

```{r echo=FALSE}
forecast_covariates |> glimpse()
```
