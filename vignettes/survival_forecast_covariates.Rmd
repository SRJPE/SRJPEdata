...
- Take the mean and sd of the log-scale *mean* weekly flow for each gage
- Scale the value (center on 0) for each gage
...
survival_forecast_covariates <- SRJPEdata::environmental_data |> 
  ...
  group_by(stream, gage_number, gage_agency, site_group, week) |> 
  # summary statistics
