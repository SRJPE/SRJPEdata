...
Eye Riffle efficiency or catch data may be used in fitting the juvenile abundance estimate model (BTSPAS) and for supplementary analysis. After initial analysis, we will reassess site decision to see how to best incorporate Eye Riffle data in modeling.
