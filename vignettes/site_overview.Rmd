...
The SR JPE modeling team selected Okie Dam as the primary site to use for the Stock Recruit because it is the site with the most historical data and has ongoing monitoring. The Okie Dam site has a rotary screw trap and a fyke trap in operation during the monitoring season.
...
The SR JPE modeling team selected Lower Clear Creek as the primary site to use for the Stock Recruit because it captures the full extent of spawning ground for spring run Chinook.
...
The SR JPE modeling team selected Hallwood as the primary site to use for the Stock Recruit because it is the site with the most historical data, it is the lowest in the system, and ongoing monitoring at this site restarted in 2023 (TODO check year on this).
