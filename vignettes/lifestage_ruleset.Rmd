...
library(tidyverse)
library(lubridate)
# TODO - Erin will push the csv
# TODO - Ashley add fry/smolt to this vignette
# Read in datasets 
...
This is applied in the weekly_data_summary script. 

```{r, echo = F}
# Note this is not the final dataset as lifestage is added below
# apply cutoffs to catch data
...
standard_catch_unmarked |> 
  filter(count != 0, is.na(life_stage)) |> glimpse()
```
