...
Feather River is currently not included in stock recruit modeling due to no adult data that represent spring run. This data gap is currently in the process of being filled.
