...
In order to apply the years to exclude information to the modeling datasets we did some additional analysis to create a table describing the stream, site, year that should be included in the SR JPE modeling.
...
years_to_include <- SRJPEdata::rst_catch |> 
...
chosen_site_years_to_model <- include |>
  ...
  mutate(site_group = case_when(site %in% lfc_sites ~ "upper feather lfc",
