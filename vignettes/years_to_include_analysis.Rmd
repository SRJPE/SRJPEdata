...
```{r, echo = FALSE}
years_exclude_nice_names <- SRJPEdata::years_to_exclude_rst_data |>
  select(
    "Stream" = stream,
    "Site" = site,
    "Run Year" = run_year,
...
```{r, echo = FALSE}
knitr::kable(SRJPEdata::years_to_exclude_rst_data |> filter(grepl("spring run specific", exclusion_type)))
```
...
We utilized strategies to come up with a list of years to exclude from modeling for adult data. See a section of the "years to exclude" table below.

```{r, echo = FALSE}

years_exclude_nice_names_adult <- SRJPEdata::years_to_exclude_adult |> select("Stream" = stream, 
                                                    "Year" = year, 
                                                    "Data Type" = data_type,
...
## years_to_exclude_adult_data object

Years to exclude adult data object can be found at `SRJPEdata::years_to_exclude_adult_data`
