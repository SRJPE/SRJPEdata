...
## Butte {.tabset}
### TODO: 
- current battle/clear site=NA subsite=NA gets joined to butte
- updated water_velocity in butte trap datasets (done)
- updated release marked_life_stage gets mapped to lifestage_id (done)
...
**- Findings:**
 ...
 - All water velocity values are NA in DB, and 92% are NA in EDI
